...
export function AppearanceSection({
  ...
  return (
    <div className="settings-panel__section" id="settings-section-appearance">
      <h3 className="settings-panel__section-title">{t('settingsPanel.appearance.title')}</h3>
      <span className="settings-panel__section-help">{t('settingsPanel.appearance.help')}</span>
      ...
      <div className="settings-panel__subsection" id="settings-section-terminal-appearance">
        <div className="settings-panel__subsection-header">
          <strong>{t('settingsPanel.appearance.terminalTitle')}</strong>
          <span>{t('settingsPanel.appearance.terminalHelp')}</span>
        </div>
